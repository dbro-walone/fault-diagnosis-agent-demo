...
export const TOPO_LAYERS: ReadonlyArray<TopoLayerDef> = [
  ...
  { code: 'S1_1', name: 'S1.1 业务应用', domain: 'S1', parent: 'S1', resourceTypes: ['BUSINESS_APP'], color: '#4ade80' },
  { code: 'S1_2', name: 'S1.2 业务服务', domain: 'S1', parent: 'S1', resourceTypes: ['BUSINESS_SERVICE'], color: '#86efac' },
  { code: 'S1_3', name: 'S1.3 存储客户端', domain: 'S1', parent: 'S1', resourceTypes: ['STORAGE_CLIENT', 'CLIENT_OS', 'MOUNT_POINT'], color: '#a7f3d0' },
  ...
  { code: 'S2_2', name: 'S2.2 网络Fabric', domain: 'S2', parent: 'S2', resourceTypes: ['NETWORK_FABRIC'], color: '#bfdbfe' },
  { code: 'S2_3', name: 'S2.3 访问链路', domain: 'S2', parent: 'S2', resourceTypes: ['ACCESS_LINK'], color: '#dbeafe' },
  { code: 'S3', name: 'S3 存储系统域', domain: 'S3', parent: 'S3', resourceTypes: [], color: '#c084fc' },
  { code: 'S3_1', name: 'S3.1 接入层', domain: 'S3', parent: 'S3', resourceTypes: ['FC_PORT', 'ETH_PORT', 'LIF'], color: '#d8b4fe' },
  { code: 'S3_2', name: 'S3.2 控制层', domain: 'S3', parent: 'S3', resourceTypes: ['CONTROLLER', 'CPU', 'MEMORY', 'CACHE'], color: '#e9d5ff' },
  { code: 'S3_3', name: 'S3.3 数据服务层', domain: 'S3', parent: 'S3', resourceTypes: ['BLOCK_SERVICE', 'NAS_SERVICE', 'OBJECT_SERVICE', 'SNAPSHOT_SERVICE', 'QOS_SERVICE', 'REPLICATION_SERVICE'], color: '#f5d0fe' },
  { code: 'S3_4', name: 'S3.4 存储资源层', domain: 'S3', parent: 'S3', resourceTypes: ['POOL', 'RAID', 'LUN', 'FILESYSTEM', 'DISK_DOMAIN'], color: '#fbcfe8' },
  { code: 'S3_5', name: 'S3.5 硬件层', domain: 'S3', parent: 'S3', resourceTypes: ['ENCLOSURE', 'DISK', 'POWER', 'FAN', 'BBU'], color: '#fecdd3' },
]
...
let cache: LayeredModelData | null = null

/**
 * 从分层演示 Case 构建分层拓扑模型（单例缓存）。
